...
namespace  YiHan.Cms.CmsApp.Mappers
{
    ...
    /// ImgCategoryDto映射配置
    /// </summary>
    public class ImgCategoryDtoMapper 
    {
    ...
    private static volatile bool _mappedBefore;
	    ...
	    /// <summary>
       ///    Configuration.Modules.AbpAutoMapper().Configurators.Add(ImgCategoryDtoMapper.CreateMappings);
    ...
    /// </summary>       
	  ...
	  // Configuration.Modules.AbpAutoMapper().Configurators.Add(ImgCategoryDtoMapper.CreateMappings);
	    ...
	    //    Mapper.CreateMap<ImgCategory,ImgCategoryEditDto>();
       //     Mapper.CreateMap<ImgCategory, ImgCategoryListDto>();

     //       Mapper.CreateMap<ImgCategoryEditDto, ImgCategory>();
    //        Mapper.CreateMap<ImgCategoryListDto,ImgCategory>();
