...
namespace  YiHan.Cms.CmsApp.Mappers
{
    ...
    private static volatile bool _mappedBefore;
	    ...
	    /// <summary>
       ///    Configuration.Modules.AbpAutoMapper().Configurators.Add(ArticeDtoMapper.CreateMappings);
    ...
    /// </summary>       
	  ...
	  // Configuration.Modules.AbpAutoMapper().Configurators.Add(ArticeDtoMapper.CreateMappings);
	    ...
	    //    Mapper.CreateMap<Artice,ArticeEditDto>();
       //     Mapper.CreateMap<Artice, ArticeListDto>();

     //       Mapper.CreateMap<ArticeEditDto, Artice>();
    //        Mapper.CreateMap<ArticeListDto,Artice>();
