...
namespace YiHan.Cms.Web.Areas.Mpa.Startup
{
            ...
            menu
                .AddItem(new MenuItemDefinition(
                    ...
                    .AddItem(new MenuItemDefinition(
                        ...
                        PageNames.App.Category.CategoryList,
                        L("Category"),
                        url: "Mpa/Category",
                        icon: "icon-grid",
                        requiredPermissionName: AppPermissions.Category
                        )
                    ).AddItem(new MenuItemDefinition(
                        PageNames.App.Artice.ArticeList,
                        L("Artice"),
                        url: "Mpa/Artice",
                        icon: "icon-book-open",
                        requiredPermissionName: AppPermissions.Artice
                        )
                    ).AddItem(new MenuItemDefinition(
                        PageNames.App.Temp.TempSystem,
                        L("TempSystem"),
                        icon: "icon-book-open",
                        requiredPermissionName: AppPermissions.TempSystem
                        )
                        .AddItem(new MenuItemDefinition(
                        PageNames.App.Temp.IndexTemp,
                        L("IndexTemp"),
                        url: "Mpa/TempSystem/",
                        icon: "icon-book-open"
                        )
