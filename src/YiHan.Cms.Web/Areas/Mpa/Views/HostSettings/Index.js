(function ($) {
    $(function () {
        ...
        $('#SaveAllSettingsButton').click(function () {
            ...
            var tenantManagementControl = $('#TenantManagementSettingsForm').serializeFormToObject();

            if (tenantManagementControl.DefaultEditionId === "null") {
                tenantManagementControl.DefaultEditionId = null;
            }

            _hostSettingsService.updateAllSettings({
                general: $('#GeneralSettingsForm').serializeFormToObject(),
                tenantManagement: tenantManagementControl,
