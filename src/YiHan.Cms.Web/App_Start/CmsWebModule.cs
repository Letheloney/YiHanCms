...
using YiHan.Cms.Web.App.Startup;//SPA!
using YiHan.Cms.Web.Areas.Mpa.Startup;//MPA!
using YiHan.Cms.Web.Bundling;
using YiHan.Cms.Web.Navigation;
using YiHan.Cms.Web.Routing;
using YiHan.Cms.WebApi;
