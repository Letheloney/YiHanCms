...
using YiHan.Cms.Tests.TestDatas;
...
namespace YiHan.Cms.Tests
{
    ...
    /// Provides methods to easily work with <see cref="CmsDbContext"/>.
    /// </summary>
    public abstract class AppTestBase : AbpIntegratedTestBase<CmsTestModule>
    {
